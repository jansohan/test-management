...
export function QuestionsIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function MarksIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function IconButton({ onClick, title, children, hoverTextColor = 'hover:text-blue-600', hoverBgColor = 'hover:bg-blue-50' }: IconButtonProps) {
  const baseButtonClasses = "p-2 rounded-lg transition-colors duration-150 text-gray-600";
  const hoverClasses = `${hoverTextColor} ${hoverBgColor}`;
